...
<body align="center">
    ...
    <div>
                <form id="entradas" action="php/opent.php" method="post" onsubmit="return validarDatos()">
                    ...
                    <div>
                        <input type="number" class="entrada-control" id="txtDinero" name="txtDinero" placeholder="Compra($)">
                    </div>
                    <div>
    ...
    <div class="table-scroll" align="center">
            ...
            <?php
                ...
                echo '<table>';
                    echo '<tr><th>Folio</th><th>Nombre</th><th>Telefono</th><th>CURP</th><th>Cantidad(kg)</th><th>Compra</th><th>Descripcion</th><th>Fecha</th></tr>';
